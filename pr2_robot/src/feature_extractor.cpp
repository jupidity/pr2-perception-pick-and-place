...
#include <pr2_robot/GetNormals.h>
//#include <pr2_robot/GetFloatArrayFeature.h>
...
private:
  ...
  bool getNormalsReq(pr2_robot::GetNormals::Request &req, pr2_robot::GetNormals::Response &rsp)
  {
...
// bool getVFHReq(pr2_robot::GetNormals::Request &req, pr2_robot::GetNormals::Response &rsp)
// {
//   pcl::PointCloud<pcl::PointXYZ> *p_cloud = new pcl::PointCloud<pcl::PointXYZ>();
//   const boost::shared_ptr<pcl::PointCloud<pcl::PointXYZ> > sp_pcl_cloud(p_cloud);
//   pcl::fromROSMsg(req.cluster, *p_cloud);
